      ...
      <div class="jumbotron">
        <div class="container">
          <h1><?php echo get_theme_mod('banner_heading', 'Banner Heading'); ?></h1>
            <p class="lead"><?php echo get_theme_mod('banner_text', 'Welcome to the Wordpress Business Theme. This theme uses the Twitter Bootstrap 3 framwork and can be customized to your linking'); ?></p>
        ...
        <div class="container">
          <div class="col-lg-4">
            <div class="block">
              ...
              <p><?php echo get_theme_mod('box1_text', 'Donec id elit non mi porta gravida at eget metus.'); ?></p>
          </div>
        </div>
          ...
          <div class="block">
              ...
              <p><?php echo get_theme_mod('box2_text', 'Donec id elit non mi porta gravida at eget metus.'); ?></p>
          </div>
          </div>
          ...
          <div class="block">
              ...
              <p><?php echo get_theme_mod('box3_text', 'Donec id elit non mi porta gravida at eget metus.'); ?></p>
          </div>
          </div>
        </div>
      </section>
